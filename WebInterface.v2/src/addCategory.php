    ...
    <div id="businesses" class="marker"></div>
      ...
      <form class="form-horizontal" id="addCategory">
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="cat-name" placeholder="Category Name" required>
          </div>
        </div>
        
        <div class="form-group col-sm-3"  style="margin-left: 40px;">
          <div class="col-sm-offset-6 col-sm-6">
            <input type="button" id="add-category" class="btn btn-success" value="Add Category" style="width: 113px;" onclick="addCategory()">
          </div>
        </div>
